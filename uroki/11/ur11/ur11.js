...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const correctAnswers = {
        q1: 1, // Сущность, имеющая состояние и поведение
        q2: 1, // Действие, на которое программа может реагировать
        q3: 1, // Объектно-ориентированное программирование
        q4: 1, // Сокрытие внутреннего состояния объекта
        q5: 1, // Программа ждёт событий и реагирует на них
        q6: 1  // Инструмент для создания программ с графическими элементами
    };

    // Пояснения к вопросам
    const explanations = {
        q1: 'Объект — это сущность, которая имеет состояние (данные) и поведение (методы).',
        q2: 'Событие — это действие (нажатие кнопки, движение мыши), на которое программа может реагировать.',
        q3: 'Объектно-ориентированное программирование (ООП) — доминирующая парадигма в современной разработке.',
        q4: 'Инкапсуляция — это сокрытие внутреннего состояния объекта от внешнего мира.',
        q5: 'В событийной модели программа не выполняется линейно, а ждёт событий и реагирует на них.',
        q6: 'Визуальная среда разработки позволяет создавать программы с графическими элементами без написания всего кода вручную.'
    };

    // Названия вопросов
    const questionNames = {
        q1: 'Вопрос 1. Что такое объект в ООП?',
        q2: 'Вопрос 2. Что такое событие в программировании?',
        q3: 'Вопрос 3. Какая парадигма программирования доминирует в современной разработке?',
        q4: 'Вопрос 4. Что такое инкапсуляция?',
        q5: 'Вопрос 5. В чём особенность событийной модели программы?',
        q6: 'Вопрос 6. Что такое визуальная среда разработки?'
    };

    // Тексты правильных ответов
    const correctTexts = {
        q1: 'Сущность, имеющая состояние и поведение',
        q2: 'Действие, на которое программа может реагировать',
        q3: 'Объектно-ориентированное программирование',
        q4: 'Сокрытие внутреннего состояния объекта',
        q5: 'Программа ждёт событий и реагирует на них',
        q6: 'Инструмент для создания программ с графическими элементами'
    };
    ...
    checkBtn.addEventListener('click', function() {
        ...
        let message = '';
        if (score === 6) {
            message = '🎉 Отлично! Вы отлично усвоили тему "Объектно-событийная модель работы программы"!';
        } else if (score >= 4) {
